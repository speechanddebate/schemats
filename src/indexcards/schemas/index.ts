...
export * from './file';
export * from './getParadigmByPersonId200';
export * from './getParadigmByPersonId200CertificationsItem';
export * from './getParadigmByPersonId200RecordItem';
export * from './invite';
...
export * from './searchParadigms200ItemChaptersItem';
